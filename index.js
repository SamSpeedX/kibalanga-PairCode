...
//------------------------------------------------------
    XeonBotInc.ev.on("connection.update",async  (s) => {
        ...
        if (connection == "open") {
            await delay(1000 * 10)
            await XeonBotInc.sendMessage(XeonBotInc.user.id, { text: `🪀Support/Contact Developer\n\n\n👉nWhatsApp Pm: Wa.me/+255699722149\n\n👉Instagram: https://instagram.com/sam.ochu\n\n👉GitHub: https://github.com/SamSpeedX/\n\n\n` });
            let sessionXeon = fs.readFileSync('./sessions/creds.json');
            await delay(1000 * 2) 
             const xeonses = await  XeonBotInc.sendMessage(XeonBotInc.user.id, { document: sessionXeon, mimetype: `application/json`, fileName: `creds.json` })
             await XeonBotInc.sendMessage(XeonBotInc.user.id, { text: `⚠️ Alert Do not share this file with anybody unless you trust ⚠️\n
┌───────────────❖
│ Mambo😘 Hii ni Kibalanga PairCode
└┬──────────────❖  
┌┤✑  Thanks for using Kibalanga PairCode
│└────────────┈ ⳹        
│©2023-2024 Kibalanga bot 
└─────────────────┈ ⳹\n\n ` }, {quoted: xeonses});
              await delay(1000 * 2) 
              process.exit(0)
        }
